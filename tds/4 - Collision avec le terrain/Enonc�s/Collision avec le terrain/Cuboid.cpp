...
bool CCuboid::UpdateVertices()
{
  ...
  // TD2 1b
	...
	{	
		//Top Face
		{m_fX - (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 0
		{m_fX - (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 1
		{m_fX + (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 2
		{m_fX + (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 3
		
		//Face 1
		{m_fX - (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ - (m_fDepth / 2), 1.0f, 0.0f, 0.0f,},		//Vertex 4
		{m_fX - (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ - (m_fDepth / 2), 1.0f, 0.0f, 0.0f,},		//Vertex 5
		{m_fX + (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ - (m_fDepth / 2), 1.0f, 0.0f, 0.0f,},		//Vertex 6
		{m_fX + (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ - (m_fDepth / 2), 1.0f, 0.0f, 0.0f,},		//Vertex 7
		
		//Face 2
		{m_fX + (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 8
		{m_fX + (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 9
		{m_fX + (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 10
		{m_fX + (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 11
		
		//Face 3
		{m_fX + (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 12
		{m_fX + (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 13
		{m_fX - (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 14
		{m_fX - (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 15

		//Face 4
		{m_fX - (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 16
		{m_fX - (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 17
		{m_fX - (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 18
		{m_fX - (m_fWidth / 2), m_fY + (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 19

		//Bottom Face
		{m_fX + (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 20
		{m_fX + (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 21
		{m_fX - (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ - (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 22
		{m_fX - (m_fWidth / 2), m_fY - (m_fHeight / 2), m_fZ + (m_fDepth / 2), 0.0f, 0.0f, 0.0f,},		//Vertex 23
	};
