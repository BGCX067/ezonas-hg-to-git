...
void Behavior::SetAcceleration( D3DXVECTOR3 _vAcceleration )
{
	m_vAcceleration = _vAcceleration;
}
...
void Behavior::SetVelocity( D3DXVECTOR3 _vVelocity )
{
...
void Behavior::SetPosition( D3DXVECTOR3 _vPosition )
{
...
D3DXVECTOR3 Behavior::GetForce()
{
	return m_vForce;
}

D3DXVECTOR3 Behavior::GetAcceleration()
{
	return m_vAcceleration;
}

D3DXVECTOR3 Behavior::GetVelocity()
{
	return m_vVelocity;
}

D3DXVECTOR3 Behavior::GetPosition()
{
	return m_vPosition;
}
