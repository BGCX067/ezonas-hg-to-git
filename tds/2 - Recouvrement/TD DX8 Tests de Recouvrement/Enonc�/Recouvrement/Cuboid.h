...
public:
	...
	bool SetTexture(LPCWSTR szTextureFilePath);
...
protected:
    D3DXVECTOR3 ComputeNormal(CUBOID_CUSTOMVERTEX* cvVertices, DWORD i, DWORD j, DWORD k);
    void ComputeVertexNormal(CUBOID_CUSTOMVERTEX* cvVertices, DWORD iVertex, DWORD j, DWORD k, DWORD w);
